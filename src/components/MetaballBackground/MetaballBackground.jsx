...
const MetaballBackground = () => {
    ...
    useEffect(() => {
        ...
        // Light theme settings (dark mode removed)
        const preset = {
            ...
            specularPower: 12,
            fresnelPower: 2.0,
            backgroundColor: new THREE.Color(0xf8f9fa),
            sphereColor: new THREE.Color(0xe5e7eb),
        ...
        const material = new THREE.ShaderMaterial({
            uniforms: {
                ...
                uCursorSphere: { value: cursorSphere3D },
